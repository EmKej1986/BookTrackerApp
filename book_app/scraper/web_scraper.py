...
class Scraper:
    ...
    def save_book_status(self, books, is_found, idx, url):
        with DatabaseConnection("../books_db.sqlite3") as db:
...
class Executor:
    ...
    def __get_urls(self):
        ...
        with DatabaseConnection(
                "../books_db.sqlite3") as db:
            self.books = db.get_titles()

        for title in self.books:
            books_urls.append(f'https://www.taniaksiazka.pl/Szukaj/q-{title[0]}')
